...
export default function Vessels({ lang }: VesselsProps) {
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen w-full">
        <Image
          src="/images/vessels/vesselsbg.jpeg"
          alt="Fleet of vessels"
          fill
        ...
        >
          <div className="max-w-4xl">
            ...
            {dict["vessels.hero.title"]}
            </h2>

            {/* Main title */}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8">
            {dict["vessels.hero.subtitle"]}
            </h1>
        ...
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="text-center">
            <h2 className="text-2xl md:text-3xl font-medium text-[#000080] uppercase mb-4">
              {dict["vessels.content.main.title"]}
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-black mb-16">
              {dict["vessels.content.main.subtitle"]}
            </h3>
            ...
            <div className="max-w-[1000px] mx-auto space-y-8">
              <p className="text-lg text-gray-700 leading-relaxed">
                {dict["vessels.content.main.description1"]}
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                {dict["vessels.content.main.description2"]}
              </p>
            </div>
